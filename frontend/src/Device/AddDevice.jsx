                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row">
                                    ...
                                    <div className="col-8">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter name of equipment" value={values.name} onChange={e => setValues({ ...values, name: e.target.value })} />
                                        <div className="row mt-3">
                                            <div className="col-5">
                                                <label style={{ fontWeight: 'bold' }} htmlFor="available">Available:</label>
                                                <div className="form-check form-switch ms-2">
                                                    < input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" checked={values.available} onClick={e => setValues({ ...values, available: !values.available })} readOnly />
                                                </div>
                                            </div>
                                            <div className="col-7 ">
                                ...
                                <div className="row mt-3">
                                    <div className="col">
                                        ...
                                        <textarea style={{height: 100}} type="text" className="form-control" placeholder="Enter description" value={values.status} onChange={e => setValues({ ...values, status: e.target.value })} />
                                    </div>
                                </div>
