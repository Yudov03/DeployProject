...
export default function Dashboard() {
    ...
    useEffect(() => {
        // Fetch data for DashboardStatistics
        // Example:
        ...
        AxiosInstance.get(`staffs/`)
            .then(res => {
                setCountStaff(res.data);
                console.log("Staffs data:", res.data);
            })
            .catch(err => console.log("Error fetching staffs:", err));
        AxiosInstance.get(`device/`)
            .then(res => {
                setCountDevice(res.data);
                console.log("Devices data:", res.data);
            })
            .catch(err => console.log("Error fetching devices:", err));
