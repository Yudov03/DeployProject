                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row">
                                    ...
                                    <div className="col-8">
                                        ...
                                        <input type="text" className="form-control" id="nameid" placeholder="Enter name of patient" value={values.name} onChange={e => setValues({ ...values, name: e.target.value })} />
                                        <div className="row mt-3">
                                            ...
                                            <div className="col-6">
                                                ...
                                                <select className="form-control" value={values.gender} id="genderid" onChange={(event) => setValues({ ...values, gender: event.target.value })}>
                                ...
                                <div className="row mt-3">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <textarea className="form-control" aria-label="With textarea" id="basicurl" placeholder="Enter address" value={values.address} onChange={e => setValues({ ...values, address: e.target.value })}></textarea>
                                    </div>
                                </div>
