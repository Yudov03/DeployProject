                                ...
                                <div className="row">
                                    ...
                                    <div className="col-8">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <select className="form-control ms-2" value={values.doctorname} onChange={(e) => setValues({ ...values, doctorname: e.target.value })}>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <select className="form-control ms-2" value={values.patientname} onChange={(e) => setValues({ ...values, patientname: e.target.value })}>
                                ...
                                <div className="row mt-3">
                                    ...
                                    {values.completed ? 
                                        <div className="mt-3 row">
                                            <div className="col-6">
                                                <label style={{ fontWeight: 'bold' }} htmlFor="rate">Rate:</label>
                                                <select className="form-control" value={values.rate} onChange={(event) => setValues({ ...values, rate: event.target.value })}>
