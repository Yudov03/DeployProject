...
function AddSchedule() {
    ...
    const [value, setValue] = useState({ title: nameFromEditStaff ? nameFromEditStaff : '', start: '', end: '', date: '' });
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="row mt-3">
                                    ...
                                    <div className="col-6">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <input type="time" className="form-control" value={value.start} onChange={(e) => setValue({ ...value, start: e.target.value })}></input>
                                        </div>
                                    </div>
                                    <div className="col-6">
                                        <label  style={{ fontWeight: 'bold' }} >End time: </label>
                                        <div className="d-flex align-items-center">
                                            <input type="time" className="form-control" value={value.end} onChange={(e) => setValue({ ...value, end: e.target.value })}></input>
                                        </div>
                                    </div>
                                </div>
